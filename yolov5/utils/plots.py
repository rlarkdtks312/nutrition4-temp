...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font="C:/Users/rkdtk/nutrition4/yolov5/font/NanumGothic.ttf", pil=False, example='abc'):
        assert im.data.contiguous, 'Image not contiguous. Apply np.ascontiguousarray(im) to Annotator() input images.'
        self.pil = pil or not is_ascii(example) or is_chinese(example)
        if self.pil:  # use PIL
            self.im = im if isinstance(im, Image.Image) else Image.fromarray(im)
            self.draw = ImageDraw.Draw(self.im)
            self.font = check_pil_font(font="C:/Users/rkdtk/nutrition4/yolov5/font/NanumGothic.ttf" if is_chinese(example) else font,
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                self.font_MYFONT = ImageFont.truetype("C:/Users/rkdtk/nutrition4/yolov5/font/NanumGothic.ttf", 40)
